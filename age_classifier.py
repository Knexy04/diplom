...
class EnsembleAgeClassifier(AgeClassifier):
    ...
    YOLO_WEIGHT = 2.5         # YOLO26 — снижен, плохо работает на камерах сверху
    POSE_WEIGHT = 1.0
    ML_WEIGHT = 1.0
    HEAD_BODY_WEIGHT = 3.0    # Head-to-body ratio — работает в любой позе
    HEIGHT_REL_WEIGHT = 3.0   # Относительная высота (к другим в кадре) — надёжный метод
    HEIGHT_ABS_WEIGHT = 2.0   # Абсолютная высота (к размеру кадра)
